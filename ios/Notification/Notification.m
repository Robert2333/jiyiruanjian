...
//        UNTimeIntervalNotificationTrigger *trigger2=[self createTrigger:1];
    UNTimeIntervalNotificationTrigger *trigger2=[self createTrigger:(timeNum+60*60*12)];
//     UNTimeIntervalNotificationTrigger *trigger3=[self createTrigger:1];
//         UNTimeIntervalNotificationTrigger *trigger4=[self createTrigger:1];
//         UNTimeIntervalNotificationTrigger *trigger5=[self createTrigger:1];
//         UNTimeIntervalNotificationTrigger *trigger6=[self createTrigger:1];
//         UNTimeIntervalNotificationTrigger *trigger7=[self createTrigger:1];
